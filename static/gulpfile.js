...
gulp.task('angular', [], function(done) {
  ...
  gulp.src(['./node_modules/angular/angular-csp.css'])
    .pipe(gulp.dest('./ui/lib/angular/css/'))
    .on('end', end);
